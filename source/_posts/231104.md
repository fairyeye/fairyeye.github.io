...
### pur-26150
	...
	API:
		查询（返回配置表数据及币种精度、CNY币种ID、CNY、费用计算类型对应关系，且翻译税率、关联协议：SCUX_SANNING_FEE_INFO_QUERY    /marmot-api/v49ECXUYP60iaTD6VDYCeIrqbnlzgazaL5HYWyv9ScGg
		...
		删除 根据ID删除，支持批量删除   SCUX_SANNING_FEE_INFO_DEL
	独立脚本：
