...
delete from sslm_supplier_basic where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_address where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_attachment where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_auth where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_bank_account where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_basic_tl where supplier_basic_id in (429330);

delete from sslm_supplier_business where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_contact where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_customer where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_custservice where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_equipment where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_fin_branch where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_finance where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_investg_basic where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_investg_business where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_invoice where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_main_business where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_main_industry where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_produce where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_proservice where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_qa where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_rd where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_service_area where tenant_id = 65493 and supplier_basic_id in (429330);

delete from sslm_supplier_sub_supplier where tenant_id = 65493 and supplier_basic_id in (429330);

-- company_id

delete from spfm_partner where tenant_id = 65493 AND partner_company_id in (105329);

delete from spfm_partner_invite where tenant_id = 65493 and invite_company_id in (105329);

delete from sslm_life_cycle where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_life_cycle_dim_sup where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_investg_header where tenant_id = 65493 and partner_company_id in (105329);

delete from sslm_supplier_investg_sum where tenant_id = 65493 and partner_company_id in (105329);

delete from sslm_firm_change_sum_his where tenant_id = 65493 and partner_company_id in (105329);

delete from sslm_supplier_other where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_supply_ability where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_supplier_sync where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_life_cycle_change_reqs where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_life_cycle_reqs where tenant_id = 65493 and supplier_company_id in (105329);

delete from sslm_supplier_change_req where tenant_id = 65493 and supplier_company_id in (105329);
...
SELECT sih.*
FROM sslm_investg_header sih
INNER JOIN (
    SELECT
        partner_company_id,
        MAX(process_date) AS max_approve_time
    FROM sslm_investg_header
    WHERE tenant_id = 1
      AND partner_company_id IN (458,454,449,429,456,455,471,472,437,453,475,443,452,473,457,481,482,438,483,485,486,487,488,495,500,527,535,558,561,562,565,566,567,568,569,570,572,574,576,577,579,580,581,582,583,671,672,673,674,675,676,678,680,682,683,684,687,689,692,695,696,697,698,700,701,702,703,704,705,707,711,713,714,715,716,717,718,722,723,724,726,727,728,730,732,733,735,736,737,742,743,744,745,746,747,748,754,755,761,762,765,767,769,771,780,781,790,793,794,795,796,797,802,816,819,822,841,844,848,301,325,465,470,357,358,355,341,390,203,226,130,177,25,343,129,258,160,411,423,245,210,171,277,191,127,76,170,436,166,393,275,15,6,265,335,318,337,161,223,886,887,362,354,196,235,205,350,339,194,297,367,381,338,269,365,334,375,397,43,253,61,402,416,94,904,905,906,32,908,918,189,1027,1039,1097,1131,272,1159,1212,1247,1248,1255,1256,1265,833,157,1321,1327,1334,1336,1337,1340,1347,1348,1349,1361,1390,1398,1401,1403,1415,1420,1425,1432,1450,1475,1517,1519,404,1537,827,1244,791,460,451,840,829,804,1575,168,281,169,305,204,321,150,379,123,158,396,37,431,217,173,342,92,273,266,310,212,264,49,395,193,348,407,279,229,280,33,82,467,372,128,1628,254,1342)
